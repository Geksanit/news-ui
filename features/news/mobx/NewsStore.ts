...
import { Category, FullNews, News, Tag } from 'shared/types/generated';
...
class NewsStore {
  ...
  public oneNews: News | null = null;

  public drafts: News | null = null;
  ...
  *getDrafts() {
    ...
    try {
      this.drafts = yield this.api.loadDrafts();
